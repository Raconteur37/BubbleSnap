...
@export var commonTexture: Texture2D;
@export var rareTexture: Texture2D;
@export var legendaryTexture: Texture2D;
...
func chooseItems():
	...
	match rarity:
		...
		"Common":
			itemOneFrame.texture_normal = commonTexture
			itemTwoFrame.texture_normal = commonTexture
			itemThreeFrame.texture_normal = commonTexture
		...
		"Rare":
			...
			itemOneFrame.texture_normal = rareTexture
			itemTwoFrame.texture_normal = rareTexture
			itemThreeFrame.texture_normal = rareTexture
		...
		"Legendary":
			...
			itemOneFrame.texture_normal = legendaryTexture
			itemTwoFrame.texture_normal = legendaryTexture
			itemThreeFrame.texture_normal = legendaryTexture
